...
function dynamicOpacity(elem) {
    ...
    opacBPBot = 200; // Opacity Breakpoint Bottom, where the text (from bottom of screen) will be fully visible
    opacBPOffset = 50; // Opacity Breakpoint Offset, causing fading a bit before the header and nav
    elem.style.opacity = Math.min( (elem.offsetTop - scrollTop - opacBPOffset)/opacBPTop, (scrollBot - elem.offsetTop - opacBPOffset)/opacBPBot );
