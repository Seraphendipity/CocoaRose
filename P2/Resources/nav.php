...
$NavArr = Array(
    array("Home","/P2/Main/home.php", "home", "", false),
    array("Archive","/P2/Main/archive.php", "folder-open", "", false),
    array("Images","/P2/Main/images.php", "picture", "", false),
    array("Contact","/P2/Main/contact.php", "question-sign", "", true)
);
